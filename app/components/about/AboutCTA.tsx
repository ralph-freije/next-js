...
export default function AboutCTA({
  ...
  return (
    <>
      ...
      {open && (
        <div
          className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 px-4 sm:px-6"
          onClick={() => setOpen(false)}
        >
          <div
            className="bg-white w-full max-w-md rounded-lg p-6 relative text-black"
